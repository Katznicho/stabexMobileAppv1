...
import { RESEND_CARD_OTP } from '../utils/constants/routes';
        ...
        >
            ...
            >
                ...
                <View style={styles.contentRow}>
                    <Text style={[{ fontSize: 20 }, generalStyles.textStyle]}>Resend Verification Code?</Text>
                </View>

                <View style={styles.contentRow}>
                    <Text style={[generalStyles.textStyle]}>
                        Please enter the card number to resend the verification code
                    </Text>
                </View>
